...
<svelte:head>
	<title>Home</title>
	<meta name="description" content="Svelte PixelChat" />
</svelte:head>

<div class="h-screen w-full bg-white overflow-hidden flex flex-col rounded-xl shadow-xl"  >
 <!-- navbar -->
 <div class=" border-b px-5 py-1 flex justify-between items-center">
	 ...
	 <!-- search -->
	 <div class=" w-1/2 relative focus-within:shadow-lg">
		 <div class="flex items-center w-full focus-within:border px-3 py-2  focus-within:border-b-0">
			 ...
			 <input type="text" placeholder="Search.." class=" w-full outline-none placeholder:text-slate-300 font-semibold">
		 </div>
	 </div>
	 <!-- profile -->
	 ...
	 <div class="h-full w-96 bg-slate-50 border-r flex flex-col">
		 ...
		 <div class="h-full">
			 ...
			 <div
				 ...
				 <div class="ml-4">
					 <p class="text-md font-semibold text-slate-600 m-0 p-0">Yaroslav Zubkp
					 </p>
					 <p class="text-xs text-slate-400 -mt-0.5 font-semibold">is is long ipsum
						 avaliable...</p>
				 </div>
			 </div>
			 ...
			 <div
				 ...
				 <img src="https://images.unsplash.com/photo-1499887142886-791eca5918cd?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=60&raw_url=true&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fHVzZXJzfGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=500 "
					 class="h-12 w-12 border-2 border-white rounded-full" alt="">
				 <div class="ml-4">
					 <p  class="text-md font-semibold text-slate-600 m-0 p-0"> Alison Alison
					 </p>
					 <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >Hello</p>
				 </div>
			 </div>
			 ...
			 <div
				 ...
				 <img src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=60&raw_url=true&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8dXNlcnN8ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=500 "
					 class="h-12 w-12 border-2 border-white rounded-full" alt="">
				 <div class="ml-4">
					 <p  class="text-md font-semibold text-slate-600 m-0 p-0"> Mircel Jones</p>
					 <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >Ok, Thanks.</p>
				 </div>
			 </div>
			 ...
			 <div
				 ...
				 <img src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=60&raw_url=true&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlcnN8ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=500"
					 class="h-12 w-12 border-2 border-white rounded-full" alt="">
				 <div class="ml-4">
					 <p  class="text-md font-semibold text-slate-600 m-0 p-0">Uran Poland</p>
					 <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >We own hidden
						 lake..</p>
				 </div>
			 </div>
